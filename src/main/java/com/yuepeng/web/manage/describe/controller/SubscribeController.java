...
public class SubscribeController extends BaseController {
    ...
    public String exportCustAccountList(Pagination<SubscribeVo> paramBean, SubscribeVo subscribeVo) throws Exception {
        ...
        logService.addLog(new TSysLog("客户订阅设置-导出", "导出客户订阅设置信息！", PmStateConstant.LOG_PLATFORM));
        this.export(response,"客户订阅设置管理" + String.format("%1$tY%1$tm%1$td", new Date()), custSubscribeEntity.class, list.getData());
        return null;
    }

    @RequestMapping("set/viewSubscribeset" + WebConstant.BUSINESS_SUFFIX)
    @ResponseBody
