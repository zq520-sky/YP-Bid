...
<head>
    ...
    <script src="${ctx.path}/resources/script/plan/planSearchHotwordSet.js?v=${ctx.version}"></script>
...
<body>
<div class="main_con">
    <form class="tableform" action="${ctx.path}/manage/planproject/hotword/queryHotwordList${ctx.pageSuffix}"
          method="post"
          id="pageForm">
        <div class="operation_box" id="operation_box">
            <div class="operation_con">
                ...
                <div class="operation_info">
                    <p:auth mcode="MENU_MANAGE_PLANPROJECT_HOTWORD_ADD">
                    ...
                    <p:auth mcode="MENU_MANAGE_PLANPROJECT_HOTWORD_EXPORT">
                        <button type="button" class="btn add_btn"
                                onclick="fun_export('${ctx.path}/manage/planproject/hotword/exportHotwordList${ctx.bizSuffix}')">
        ...
        <div class="search_box" id="search_box">
            ...
            <div class="search_btncon">
                <p:auth mcode="MENU_MANAGE_PLANPROJECT_HOTWORD_SEARCH">
                        ...
                        <c:forEach items="${pageData.data }" var="data" varStatus="staus">
                            <tr>
                                ...
                                <td class="operation_td">
                                    <p:auth mcode="MENU_MANAGE_PLANPROJECT_HOTWORD_VIEW">
                                        <button class="operationbtn" type="button"
                                                onclick="viewPage(${data.hotwordId});">
                                            <span>查看</span>
                                        </button>
                                    </p:auth>
                                    <p:auth mcode="MENU_MANAGE_PLANPROJECT_HOTWORD_UPDATE">
                                        <button class="operationbtn" type="button"
                                                onclick="editPage(${data.hotwordId});">
                                            <span>编辑</span>
                                        </button>
                                    </p:auth>
                                    <p:auth mcode="MENU_MANAGE_PLANPROJECT_HOTWORD_DEL">
                                        <button class="operationbtn" type="button"
                                                onclick="delHotWord(${data.hotwordId});">
                                            <span>删除</span>
                                        </button>
                                    </p:auth>
                                </td>
...
<div id="addId" name="addHotWord" class="add_box mCustomScrollbar_y" data-mcs-theme="dark" style="display:none;">
    <form method="post" id="addForm" action="${ctx.path}/manage/planproject/hotword/addHotword${ctx.bizSuffix}">
        <div class="add_list">
...
<div id="editId" name="editName" class="add_box mCustomScrollbar_y" data-mcs-theme="dark" style="display:none;">
    <form method="post" id="editForm" action="${ctx.path}/manage/planproject/hotword/updateHotword${ctx.bizSuffix}">
