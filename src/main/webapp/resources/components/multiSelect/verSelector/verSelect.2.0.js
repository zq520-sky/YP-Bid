window.verjs_select = (function () {
    ...
    select.prototype = {
        ...
        dom_code() {
            ...
            options_list.style.zIndex = this.config.zIndex;
            options_list.style.overflow = this.config.listOverFlow;
            ...
            var _search_height = this.config.searchHeight;
            ...
            let _height = (this.config.body_height - this.config.searchHeight - 5);
            ul.style.maxHeight = _height + 'px';
            ul.style.height = _height + 'px';
        ...
        config: {
            ...
            zIndex: '999',
            listOverFlow: 'hidden',//下拉列表超出是否显示滚动
            searchHeight: '60',
