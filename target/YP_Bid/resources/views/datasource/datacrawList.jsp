                    ...
                    <table>
                        ...
                        <c:forEach items="${pageData.data }" var="data" varStatus="staus">
                            <tr>
                                ...
                                <td title="<fmt:formatDate value='${data.exeStartTime }' pattern='HH:mm:ss'/>">
                                    <fmt:formatDate value='${data.exeStartTime }' pattern='HH:mm:ss'/>-<fmt:formatDate
                                        value='${data.exeEndTime }' pattern='HH:mm:ss'/>
                                </td>
