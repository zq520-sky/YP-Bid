...
<head>
    ...
    <script src="${ctx.path}/resources/script/describe/custDescribeSearch.js?v=${ctx.version}"></script>
...
<body>
<div class="main_con">
    <form class="tableform" action="${ctx.path}/manage/subscribe/search/querySubscribeSearchList${ctx.pageSuffix}" method="post"
          id="pageForm">
        <div class="operation_box" id="operation_box">
            <div class="operation_con">
                <div class="currenttit"></div>
                <div class="operation_info">
                    <p:auth mcode="MENU_MANAGE_SUBSCRIBE_SEARCH_EXPORT">
                        <button type="button" class="btn add_btn"
                                onclick="fun_export('${ctx.path}/manage/subscribe/search/exportSubscribeSearchList${ctx.bizSuffix}')">
        ...
        <div class="search_box" id="search_box">
            ...
            <div class="search_btncon">
                <p:auth mcode="MENU_MANAGE_SUBSCRIBE_SEARCH_SEARCH">
                    ...
                    <table>
                        ...
                        <c:forEach items="${pageData.data }" var="data" varStatus="staus">
                            <tr>
                                ...
                                <td title="<fmt:formatDate value='${data.searchTime }' pattern='yyyy-MM-dd HH:mm:ss'/>">
                                    <fmt:formatDate value='${data.searchTime }' pattern='yyyy-MM-dd HH:mm:ss'/>
                                </td>
                                <td class="operation_td">
                                    <p:auth mcode="MENU_MANAGE_SUBSCRIBE_SEARCH_VIEW">
                                        <button class="operationbtn" type="button" onclick="viewPage(${data.subscribeSearchId});">
                                            <span>查看</span>
                                        </button>
                                    </p:auth>
                                </td>
