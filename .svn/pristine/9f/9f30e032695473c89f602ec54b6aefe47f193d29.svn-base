...
<head>
    ...
    <script src="${ctx.path}/resources/script/collect/custCompanyCollect.js?v=${ctx.version}"></script>
        ...
        <div class="operation_box" id="operation_box">
            <div class="operation_con">
                ...
                <div class="operation_info">
                    <p:auth mcode="MENU_MANAGE_COLLECT_COMPANY_EXPORT">
                        <button type="button" class="btn add_btn"
                                onclick="fun_export('${ctx.path}/manage/collect/company/exportCompanyList${ctx.bizSuffix}')">
                ...
                <ul>
                    <li>
                        <input type="text" id="custCodeAndMobile" name="mobile" class="inputtext" placeholder="客户编号\手机号"
                               value="${companyCollectVo.mobile}"/>
                    </li>
                    <li>
                        <input type="text" id="projectCompanyName" name="projectCompanyName" class="inputtext" placeholder="招标单位名称"
                               value="${companyCollectVo.projectCompanyName}"/>
                    </li>
                </ul>
            </div>
            <div class="search_btncon">
                <p:auth mcode="MENU_MANAGE_COLLECT_COMPANY_SEARCH">
                        ...
                        <c:forEach items="${pageData.data }" var="data" varStatus="staus">
                            <tr>
                                ...
                                <td class="operation_td">
                                    <p:auth mcode="MENU_MANAGE_COLLECT_COMPANY_VIEW">
                                        <button class="operationbtn" type="button" onclick="viewPage(${data.projectCompanyId});">
                                            <span>查看</span>
                                        </button>
                                    </p:auth>
                                </td>
...
<div id="viewId" class="add_box mCustomScrollbar_y" >
    <form method="post" id="viewForm">
        ...
        <div class="add_list">
            <h5>招标单位编号：</h5>
            <div class="add_value">
                <span id="projectCompanyCode"></span>
            </div>
        </div>
        <div class="add_list">
            <h5>招标单位名称：</h5>
            <div class="add_value">
                <span id="projectCompanyName"></span>
            </div>
        </div>
        <div class="add_list">
            <h5>收藏时间：</h5>
