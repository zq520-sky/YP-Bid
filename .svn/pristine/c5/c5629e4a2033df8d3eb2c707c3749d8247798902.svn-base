...
UE.I18N['zh-cn'] = {
    'labelMap':{
        ...
        'textinput':'单行输入框','textarea':'多行输入框','select':'下拉菜单','checkbox':'选择框', 'datetime':'日期控件', 'auto':'宏控件', 'htmleditor':'编辑器', 
        'userdialog':'人员选择框', 'deptdialog':'部门选择框', 'roledialog':'角色选择框','detail':'明细字段','multiimg':'本地图片上传','sutuimage':'速途图片空间'
    },
    'insertorderedlist':{
        'num':'1,2,3...',
        'num1':'1),2),3)...',
    ...
    'docfield':{
    	'static':{
    		lang_tip:"注意：必须在编辑器中输入于此[***XXX***]相同的字段才能识别！"
    	}
    },
    'flowno':{
    	'static':{
    ...
    'textinput':{
    	'static':{
    		lang_input_name:"控件名称：",
    		lang_input_default_val:"默认值：",
    		lang_input_font_color:"字体颜色：",
    		lang_input_font_size:"字体大小：",
    		lang_input_fmt:"是否使用千位分隔符格式化："
    	}
    },
    'textarea':{
    	'static':{
    ...
    'datetime':{
    	'static':{
    		lang_input_name:"控件名称：",
    		lang_input_fmt_val:"格式化类型："
    	}
    },
    'auto':{
    	'static':{
	    	lang_input_name:"控件名称：",
	    	lang_input_auto_type:"宏控件类型：",
			lang_input_font_color:"字体颜色：",
			lang_input_font_size:"字体大小："
    	}
    },
    'htmleditor':{
    	'static':{
    		lang_input_name:"编辑器名称：",
    		lang_input_width_val:"编辑器宽度：",
    		lang_input_height_val:"编辑器高度："
    	}
    },
    'userdialog':{
    	'static':{
    		lang_input_name:"控件名称：",
    		lang_input_cols_val:"输入框列数：",
    		lang_input_rows_val:"输入框行数：",
    		lang_input_font_color:"字体颜色：",
    		lang_input_font_size:"字体大小："
    	}
    },
