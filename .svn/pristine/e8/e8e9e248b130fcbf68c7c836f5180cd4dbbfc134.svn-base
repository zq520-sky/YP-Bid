        ...
        <div class="operation_box" id="operation_box">
            <div class="operation_con">
                ...
                <div class="operation_info">
                    <p:auth mcode="MENU_MANAGE_DICT_INFOTYPE_INSERT">
...
<!-- 新增 -->
<div id="addInfoType" name="addInfoType" class="add_box mCustomScrollbar_y" data-mcs-theme="dark" style="display:none;">
    <form method="post" id="addForm" action="${ctx.path}/manage/dict/infoType/addInfoType${ctx.bizSuffix}">
        <div class="add_list">
            <h5><em style="color: red;">*</em>招标信息类型名称：</h5>
            <div class="add_value">
                <input type="text" id="infotypeNameAdd" name="infotypeName" maxlength="32" class="inputtext"/>
            </div>
        </div>
        <div class="add_list">
            <h5><em style="color: red;">*</em>所属类别：</h5>
            <div class="add_value">
                <select class="select" name="classId" id="classIdAdd" type="select">
                    <option value="">全部</option>
                    <option value="1">
                            招标
                    </option>
        ...
        <div class="add_list">
            ...
            <div class="add_value">
                <input type="text" id="orderNumAdd" name="orderNum" maxlength="32" class="inputtext"/>
            </div>
        </div>
        <div class="add_list">
            <h5>备注：</h5>
            <div class="add_value">
                <input type="text" id="remarkAdd" name="remark" maxlength="30" class="inputtext"/>
            </div>
        </div>
    </form>
</div>
