    ...
    function _buildControls() {
        ...
        if (_inArray(config.controls, 'restart')) {
            html.push(
				...
				'<i class="plyr_ico restart_ico"></i>',
        ...
        if (_inArray(config.controls, 'play')) {
            html.push(
                ...
                '<i class="plyr_ico play_ico"></i>',
                '<span class="sr-only">' + config.i18n.play + '</span>',
                '</button>',
                '<button type="button" data-player="pause">',
                '<i class="plyr_ico pause_ico"></i>',
        ...
        if (_inArray(config.controls, 'fast-forward')) {
            html.push(
                ...
                '<i class="plyr_ico fast-forward"></i>',
        ...
        if (_inArray(config.controls, 'mute')) {
            html.push(
                ...
                '<svg class="plyr_ico icon-muted icon_no"></svg>',
                '<svg class="plyr_ico icon_off"></svg>',
        ...
        if (_inArray(config.controls, 'fullscreen')) {
            html.push(
                ...
                '<svg class="plyr_ico icon-exit-fullscreen">退出全屏</svg>',
                '<svg class="plyr_ico icon-enter-fullscreen">放大</svg>',
