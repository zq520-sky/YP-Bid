...
public class IdGen {
	...
	public static String getYmdRandom(){
		...
		return DateUtil.getYear()+ DateUtil.getMonth()+ DateUtil.getDay()+df.format(RandomUtils.nextInt(0, 1000));
	}
	...
	public static String getBusinessCode(String headStr){
		...
		return headStr+""+sdf.format(new Date())+ new DecimalFormat("0000").format(RandomUtils.nextInt(0, 1000));
	}
